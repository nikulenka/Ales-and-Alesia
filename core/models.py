...
class ObservableFactor(BaseModel):
    ...
    note: Annotated[str | None, Field(description="Пояснительный текст для агента")] = None
...
class DiagnosticAction(BaseModel):
    ...
    note: Annotated[str | None, Field(description="Почему это действие информативно")] = None
...
class DispatchResult(BaseModel):
    ...
    service: ServiceType | None = Field(default=None, description="Сервис для маршрутизации")
